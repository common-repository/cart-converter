...
class WC_Report_Carts_By_Date extends WC_Admin_Report {
	...
	public function get_chart_legend() {
		...
		$legend[] = array(
			'title' => sprintf( __( '%s abandoned carts in this period.', 'cart_converter' ), '<strong>' . sizeof($abandoned_carts) . '</strong>' ),
			'color' => $this->chart_colours['abandoned_carts'],
			'highlight_series' => 1
		);
		$legend[] = array(
			'title' => sprintf( __( '%s orders placed', 'cart_converter' ), '<strong>' . $total_orders . '</strong>' ),
